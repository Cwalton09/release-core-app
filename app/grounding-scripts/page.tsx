...
const scripts: Script[] = [
  {
    ...
    lines: [
      ...
      "Tap gently with two fingers on each point while repeating the statements.",
      ...
      "Eyebrow Point: This fear my body has been holding.",
      "Side of Eye: This constant need to stay alert.",
      "Under Eye: This pressure in my nervous system.",
      "Under Nose: My body learned to protect me through fear.",
      "Chin Point: But I do not need to stay in survival mode forever.",
      "Collarbone Point: I thank my body for trying to protect me.",
      "Under Arm: I am safe enough to begin letting this go.",
      "Top of Head: My body is learning a new pattern now.",
      "Take a deep breath. Now begin the second round.",
      "Eyebrow Point: I release the need to constantly brace for danger.",
      "Side of Eye: I release the habit of overthinking for protection.",
      "Under Eye: I release stored tension from my body.",
      "Under Nose: My nervous system is allowed to soften now.",
      "Chin Point: I am safe to relax.",
      "Collarbone Point: I am safe to breathe deeply.",
      "Under Arm: I am safe to feel calm.",
      "Top of Head: Peace is safe for my body now.",
  ...
  },
  {
    ...
    icon: "✨",
    lines: [
      "Your body is safe to receive more.",
      ...
      "It is safe to receive. It is safe to succeed. It is safe to be supported.",
      "It is safe for life to work out for you.",
      ...
      "You are safe now.",
      "Safe to soften. Safe to breathe deeply. Safe to trust again.",
      "Safe to believe that life can become easier.",
      ...
      "You are not stuck anymore. You are not trapped anymore.",
      "A new reality is becoming safe for your body now.",
      "One where you are supported. One where things flow easier.",
      ...
      "And tonight, your body is learning exactly that.",
    ],
  },
  {
    id: "somatic",
    ...
    icon: "🫀",
    lines: [
      "My body no longer needs to create symptoms to get my attention.",
      "I am safe now.",
      ...
      "And tonight, my body remembers how.",
    ],
  },
  {
    id: "nightly",
    ...
    icon: "🌙",
    lines: [
      "Each step takes only a few seconds. Do these in order before bed.",
      "Step one. Tap lightly on either collarbone point and say:",
      "Body, the danger is over. You can let this go now.",
      "Step two. Jaw Release. Gently open and close your jaw, side to side.",
      "Jaw tension equals survival mode. Releasing it tells your brain: We are safe.",
      "Say: I release old reactions.",
      "Step three. Exhale Drop. Let your shoulders fall while exhaling through your mouth.",
      "Say: My body can stand down.",
      "Step four. Sweep the Body. Take both hands and sweep down your chest, ribs, stomach, and hips.",
      "Say: This pattern is erased.",
      "Step five. Place your hand on your heart.",
  ...
  },
  {
    ...
    icon: "👁️",
    lines: [
      "Use this anytime you feel overwhelmed, tense, or dysregulated.",
      "Step one. Without moving your head, hold your eyes as far to the right as they will go.",
      "Hold until you feel a sigh, swallow, or yawn.",
      "That response is the vagus nerve switching on.",
      "Step two. Now move your eyes as far to the left as they will go.",
      "Hold again until you sigh or swallow.",
      "That is the parasympathetic system taking over.",
      "You will feel lighter and more grounded in under thirty seconds.",
    ],
  },
  {
    id: "sleep",
    ...
    icon: "💤",
    lines: [
      "Do this lying in bed. Your brain waves are entering theta state — imprinting mode.",
      "Put one hand on your heart and one on your lower belly.",
      "Breathe in for four seconds through your nose.",
      "Breathe out for eight seconds through your mouth.",
      "Repeat three times.",
      "Then repeat softly:",
  ...
  },
  {
    ...
    icon: "🧠",
    lines: [
      "I give my mind permission to slow down.",
      ...
      "And my body is learning that safety now.",
    ],
  },
  {
    id: "calming",
