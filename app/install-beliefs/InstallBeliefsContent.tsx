...
export default function InstallBeliefsPage() {
  ...
  const installBeliefs = useMemo(() => {
    const matched = selectedCore
      .flatMap((belief) => beliefFlipMap[belief] ?? []);
  ...
  return (
    <AppShell title="Install New Beliefs">
      <div className="space-y-6">
        ...
        {/* What your body needed — now receiving */}
        {(unmetNeeds.length > 0 || ownWords) && (
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 shadow-sm space-y-4">
            <h2 className="text-xl font-semibold text-slate-900">
              What you needed — you can receive now
            </h2>
            <p className="text-sm leading-7 text-slate-700">
              Your body identified what it was longing for. It is safe to receive that now.
            </p>
            {unmetNeeds.length > 0 && (
            ...
            <p className="text-sm leading-7 text-slate-700">
              You are allowed to receive this now. Your body is ready.
            </p>
          </div>
        )}
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3 text-sm leading-7 text-slate-700">
            ...
            <p>
              Gently breathe into {areaText} without forcing anything. Just let your breath find it.
            </p>
          </div>
        </div>
        ...
        {/* Install beliefs — only from what they selected */}
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 shadow-sm space-y-4">
          <h2 className="text-xl font-semibold text-slate-900">
            Let these truths install now
          </h2>
          <p className="text-sm leading-7 text-slate-700">
            Read each one slowly. Breathe between each one. Let your body feel the truth of these — not just your mind.
          </p>
          <div className="space-y-3 text-sm leading-7 text-slate-700">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3 text-sm leading-7 text-slate-700">
            <p>
              Notice what your body feels like now. Is there more softness, space, warmth, movement, or calm?
            </p>
            <p>
              Use your sway test to ask your body — is there another layer underneath this that is ready to be worked on today?
            </p>
            <p>
              If yes, start a new session with that layer. If no, your body is ready to rest and integrate.
            </p>
          </div>
