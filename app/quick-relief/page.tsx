...
const emotions: Emotion[] = [
  {
    id: "anxious",
    label: "Anxious / Panicking",
    icon: "💨",
    color: "#6BA8B4",
    breath: {
      title: "Physiological Sigh",
      description: "The fastest way to calm your nervous system — one breath is enough.",
      phases: [
        { label: "Inhale through nose", duration: 3 },
        { label: "Second inhale through nose", duration: 1 },
        { label: "Long exhale through mouth", duration: 8 },
      ],
    },
    ...
    statement: [
      ...
      "My nervous system is responding to a signal — not a real threat.",
      "I am safe enough to breathe.",
  ...
  },
  {
    ...
    breath: {
      ...
      description: "A long exhale activates the vagus nerve and slows everything down.",
      phases: [
        { label: "Inhale through nose", duration: 4 },
        { label: "Exhale through mouth", duration: 8 },
      ],
    },
    ...
    statement: [
      "I do not have to handle everything right now.",
      "I am allowed to take this one breath at a time.",
      "Not everything on my list is an emergency.",
  ...
  },
  {
    ...
    breath: {
      ...
      description: "Deeply settling — gives your nervous system permission to rest.",
      phases: [
        { label: "Inhale through nose", duration: 4 },
    ...
    statement: [
      ...
      "Sadness is not something to fix — it is something to move through.",
      "I am allowed to grieve what I have lost.",
  ...
  },
  {
    ...
    breath: {
      title: "Box Breathing",
      description: "Regulates the fight response and brings your prefrontal cortex back online.",
      phases: [
    ...
    statement: [
      ...
      "This anger has information — and I can hear it without being controlled by it.",
      "I am allowed to feel this without acting from it.",
      "I release the need for things to be different right now.",
      "Other people's behavior does not determine my state.",
      "I can be bothered and still be okay.",
    ],
  ...
  },
  {
    ...
    breath: {
      ...
      description: "Short sharp inhales bring you back into your body gently.",
      phases: [
        { label: "Sharp inhale through nose", duration: 2 },
        { label: "Sharp inhale through nose", duration: 2 },
        { label: "Slow exhale through mouth", duration: 6 },
      ],
    },
    ...
    statement: [
      ...
      "I do not have to feel everything at once.",
  ...
  },
  {
    ...
    breath: {
      title: "Heart Breath",
      description: "Breathe directly into your heart space — this activates self-compassion.",
      phases: [
        { label: "Inhale into your heart", duration: 5 },
        { label: "Hold and soften", duration: 3 },
        { label: "Exhale with release", duration: 7 },
      ],
    },
    ...
    statement: [
      ...
      "I deserve the same compassion I would give someone I love.",
      "Shame is not the truth — it is a pattern my nervous system learned.",
      "I forgive myself for not knowing what I did not yet know.",
  ...
  },
  {
    ...
    breath: {
      ...
      description: "Clinically shown to activate the parasympathetic system and prepare the body for sleep.",
      phases: [
        { label: "Inhale through nose", duration: 4 },
        { label: "Hold", duration: 7 },
        { label: "Exhale through mouth", duration: 8 },
    ...
    statement: [
      "I give my mind permission to stop solving.",
      "Everything that needs to happen tomorrow will still be there.",
      "Right now the only thing I need to do is rest.",
      "My body knows how to sleep — I just need to get out of its way.",
      "I am safe. The day is done. I can let go now.",
      "Everything that isn't mine dissolves as I sleep.",
    ],
    reframe: "Sleep is not something I have to earn. My body is designed for this.",
  },
  {
    id: "unknown",
    label: "I Don't Know — Just Help",
    icon: "🌿",
    color: "#1D9E75",
    breath: {
      title: "Physiological Sigh",
      description: "When you don't know what you feel — start with one breath. Your body will follow.",
      phases: [
        { label: "Inhale through nose", duration: 3 },
        { label: "Second inhale through nose", duration: 1 },
        { label: "Long exhale through mouth", duration: 8 },
    ...
    statement: [
      ...
      "My body knows what it needs even when my mind doesn't.",
      "I am allowed to not know and still be okay.",
      "Something in me led me here — and that something was looking out for me.",
      "I am safe. I am here. That is enough for right now.",
    ],
      ...
      <div className="relative flex items-center justify-center w-36 h-36 mb-4">
        ...
        <div
          ...
          style={{
            ...
            backgroundColor: isRunning ? color + "22" : "#E1F5EE",
            border: `2px solid ${isRunning ? color : "#1D9E75"}`,
            transitionDuration: "700ms",
            transitionTimingFunction: "ease-in-out",
          }}
        >
          {done ? (
            <span className="text-xs text-calm-600 text-center px-2">✓ Done</span>
          ) : isRunning ? (
            <>
              <span className="text-xl font-light text-slate-700">{secondsLeft}</span>
              <span className="text-xs text-slate-500 mt-0.5 text-center px-2 leading-3">{currentPhase.label}</span>
            </>
          ) : (
...
export default function QuickRelief() {
  ...
  return (
    <AppShell
      title="Quick Relief"
      subtitle="A guided 3-minute sequence to help your nervous system find safety right now."
    >
      {!selected ? (
        <>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-2">
            {emotions.map((e) => (
              <button
                ...
                className="rounded-xl border border-calm-200 bg-white px-4 py-4 text-left transition-all hover:border-calm-300 hover:bg-calm-50"
              >
        ...
        <div>
          ...
          {step >= 1 && (
            <StepCard number={1} title={selected.breath.title}>
              ...
              {step === 1 && (
                <button onClick={() => setStep(2)} className="mt-2 w-full rounded-xl bg-calm-600 py-2.5 text-sm font-medium text-white transition hover:bg-calm-700">
                  I completed the breath →
                </button>
              )}
            </StepCard>
          )}
          ...
          {step >= 2 && (
            <StepCard number={2} title="Body Anchor">
              ...
              {step === 2 && (
                <button onClick={() => setStep(3)} className="mt-4 w-full rounded-xl bg-calm-600 py-2.5 text-sm font-medium text-white transition hover:bg-calm-700">
                  I'm grounded →
                </button>
              )}
            </StepCard>
          ...
          {step >= 3 && (
            <StepCard number={3} title="Calming Statements">
              ...
              {step === 3 && (
                <button onClick={() => setStep(4)} className="mt-4 w-full rounded-xl bg-calm-600 py-2.5 text-sm font-medium text-white transition hover:bg-calm-700">
                  I feel a shift →
                </button>
              )}
            </StepCard>
          ...
          {step >= 4 && (
            <StepCard number={4} title="New Belief">
              ...
              <button
                onClick={() => { const text = selected.reframe + ". " + selected.reframe + ". " + selected.reframe; speak(text); }}
              ...
              <div className="rounded-xl border border-calm-200 bg-white px-4 py-4 text-center">
                ...
                <button onClick={reset} className="mt-4 rounded-full border border-calm-200 px-5 py-2 text-sm text-calm-700 transition hover:bg-calm-50">
                  Start again
                </button>
              </div>
            </StepCard>
